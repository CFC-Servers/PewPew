...
-- General Information
BULLET.Name = "Extended Range Heavy Laser A.P.S."
BULLET.Author = "Hexwolf ( Base by Divran )"
BULLET.Description = "The Extended Range Heavy Laser A.P.S will target PewPew bullets in a 75 degree cone and destroy them after hitting them 3 times, has improved range but lower RPM and coverage. Has unlimited ammo."
