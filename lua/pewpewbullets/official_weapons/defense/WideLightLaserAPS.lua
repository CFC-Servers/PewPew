...
-- General Information
BULLET.Name = "Wide Light Laser A.P.S."
BULLET.Author = "Hexwolf (Base by Divran)"
BULLET.Description = "The Light Laser A.P.S will target PewPew bullets in a 75 degree cone and destroy them after hitting them 5 times, has reduced range but improved RPM. Has unlimited ammo."
